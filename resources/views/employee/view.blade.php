...
<section class="content-header">
  	...
  	<section class="content">
    	<div class="container-fluid">
              ...
              <form method="post" action="{{route('employee.filter-employee')}}">
              <div class="row">
              @csrf
                ...
                <table class="table table-striped CommonDataTables" id="">
                  <thead>
                    <tr>
                      ...
                      <th width="15%">{{__('web.Joining Date')}}</th>
                  ...
                  @foreach($employee as $key)  
                    <tr>
                      ...
                      <td>{{empty($key['joining_date'])?"-":date('d-M-Y',strtotime($key['joining_date']))}}</td>
