...
<section class="content-header">
  	...
  	<section class="content">
        ...
        <div class="card">
              <form role="form" method="post" name="userForm" id="userForm" enctype="multipart/form-data" action="{{route('store.create-items')}}">
                @csrf
                <span class='arrow'>
                  ...
                  <div class="col-lg-3">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                      ...
                      <input type="text" class="form-control" name="item_size" placeholder="Enter Size" required="" value="{{old('item_size')}}">
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                      ...
                      <input type="number" class="form-control" id="confirm_password" name="sale_price" placeholder="Sale Price" required="" value="{{old('sale_price')}}">
                    </div>
                  </div>
                   ...
                   <div class="col-lg-3">
                      ...
                      <input type="text" class="form-control" id="confirm_password" name="purchase_price" placeholder="Sale Price" required="" value="{{old('sale_price')}}">
                    </div>
                    <div class="col-lg-3">
