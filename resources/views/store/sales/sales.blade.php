...
<section class="content-header">
  	...
  	<section class="content">
    	<div class="container-fluid">
            ...
            <div class="card">
            <form role="form" method="post" name="userForm" id="userForm" enctype="multipart/form-data" action="{{route('store.search-all-sales')}}">
                @csrf
                <span class='arrow'>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="sport" class="form-control" value="@if(isset($sport)) {{$sport}} @endif" autocomplete="false"/>
                  </div>
                  </div>
                  <div class="col-md-2">
                  <div class="form-group">
                ...
                <table class="table table-striped CommonDataTables" >
                  ...
                  @foreach($sales as $key)  
                    <tr>
                      ...
                      &nbsp;&nbsp;&nbsp;<a href="{{route('store.sales-edit',$key->sale_id)}}"><i class="fa fa-edit text-info"></i></a>
                      &nbsp;&nbsp;&nbsp;<a onclick="return confirm('Arr you sure?')" href="{{route('store.sales-delete',$key->sale_id)}}"><i class="fa fa-trash text-danger"></i></a></td>
                    </tr>
                    <?php
