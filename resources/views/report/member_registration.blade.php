...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{__('web.Members Registration')}}</h1>
          </div>
        </div>
      </div>
</section>
  	...
  	<section class="content">
    	<div class="container-fluid">
              ...
              <form method="post" action="{{route('reports.filter-members-registration')}}">
              <div class="row">
              @csrf
                ...
                <table class="table table-striped CommonDataTables" id="">
                  <thead>
                    <tr>
                      ...
                      <th width="20%">{{__('web.Payment Date')}}</th>
                      <th width="30%">{{__('web.Added on')}}</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
