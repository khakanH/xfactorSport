...
<section class="content-header">
  	...
  	<section class="content">
        ...
        <div class="card">
        <form id="formCafe" action="{{route('cafeteria.sales-update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <span class='arrow'>
                    ...
                    @endforeach
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="Current_Stock" value="{{$sales_data->qty}}" id="Current_Stock" class="form-control" readonly
                                    autocomplete="false" required />
                            </div>
                        </div>
