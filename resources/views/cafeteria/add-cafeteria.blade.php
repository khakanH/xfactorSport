...
<section class="content-header">
  	...
  	<section class="content">
        ...
        <div class="card">
              <form role="form" method="post" name="userForm" id="userForm" enctype="multipart/form-data" action="{{route('cafeteria.save-cafeteria')}}">
                @csrf
                <span class='arrow'>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="item_batch" id="Batch" class="form-control" readonly  autocomplete="false" required/>
                  </div>
                  </div>
                  <div class="col-md-2">
                  <div class="form-group">
                    <label>{{ __('Item Volume') }}</label>
                    <input type="text" name="item_volume" id="Volume" class="form-control" readonly  autocomplete="false" required/>
                  </div>
                  </div>
                  <div class="col-md-2">
                  <div class="form-group">
