...
<section class="content-header">
  	...
  	<section class="content">
        ...
        <div class="card">
              ...
              <form role="form" method="post" enctype="multipart/form-data" action="{{route('register.save-championship')}}">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      ...
                      <label for="name">{{__('web.Championship Name')}}</label>
                       <input autocomplete="off" id="championship_name" name="championship_name" class="form-control" required value="{{old('championship_name')}}">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="date" class="form-control datepicker_dropdown" id="date" name="date" required="" value="{{old('date')}}">
